...
public class Solution {
    ...
    public static void sort(List<Stock> list) {
        list.sort(new Comparator<Stock>() {
           ...
           @Override
            public int compare(Stock o1, Stock o2) {
               double profit1 = o1.containsKey("change") ? (double) o1.get("change") :
                       (double) o1.get("last") - (double) o1.get("open");

               double profit2 = o2.containsKey("change") ? (double) o2.get("change") :
    ...
    public static List<Stock> getStocks() {
       ...
       // stocks.add(new Stock("Fake Intel Corporation", "INTCA", 21.61, 21.53));
